...
secure_ssh_setup() {
    ...
    echo
    print_info "=== Шаг 1: Проверка пользователей ==="
    if ! check_existing_sudo_users; then
        # Создаем нового пользователя
        echo
        print_info "=== Создание нового пользователя ==="
    ...
    echo
    print_info "=== Шаг 2: Настройка SSH ключей ==="
    ...
    echo
    print_info "=== Шаг 3: Настройка SSH порта ==="
    ...
    echo
    print_info "=== Шаг 4: Настройка Fail2Ban ==="
    ...
    echo
    print_info "=== Шаг 5: Настройка файрвола ==="
    ...
    echo
    print_info "=== Шаг 6: Тестирование SSH соединения ==="
    ...
    # Шаг 7: Финализация
    echo
    print_info "=== Шаг 7: Финализация настройки ==="
    ...
    # Итоговая информация
    echo
    print_ok "=== НАСТРОЙКА SSH ЗАВЕРШЕНА УСПЕШНО ==="
    echo
