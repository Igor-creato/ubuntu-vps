...
# The file is generated by this script at runtime, so ShellCheck cannot resolve it statically.
...
YAML
  ...
  # Single quotes intentionally pass the variable-name allowlist to envsubst unchanged.
